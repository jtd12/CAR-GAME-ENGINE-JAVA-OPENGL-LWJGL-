		...
		*/
		...
		while (!Display.isCloseRequested()) {
			...
			*/
			...
			{
			roues_.get(0).setParent(player_,terrains.get(0),9,14);
			roues_.get(1).setParent(player_,terrains.get(0),-6.5f,-1.5f);
			roues2_.get(0).setParent(player_,terrains.get(0),9,14);
			roues2_.get(1).setParent(player_,terrains.get(0),-6.5f,-1.5f);
			for(int i=0;i<murs.size();i++)
			if(collid.isCollideDroite(player_.getPosition(),new Vector3f(player_.getScaleX(),player_.getScaleY(),player_.getScaleZ()),murs.get(i).getPosition(), new Vector3f(murs.get(i).getScaleX(),murs.get(i).getScaleY(),murs.get(i).getScaleZ()),player_))
				player_.setSpeed(0);
			player_.move(terrains.get(0),roues_,roues2_);
			}
			if(terrains.get(1).getTerrain2())
			{
			roues_.get(0).setParent(player_,terrains.get(1),9,14);
			roues_.get(1).setParent(player_,terrains.get(0),-6.5f,-1.5f);
			roues2_.get(0).setParent(player_,terrains.get(0),9,14);
			roues2_.get(1).setParent(player_,terrains.get(0),-6.5f,-1.5f);
			for(int i=0;i<murs.size();i++)
		    if(collid.isCollideDroite(player_.getPosition(),new Vector3f(player_.getScaleX(),player_.getScaleY(),player_.getScaleZ()),murs.get(i).getPosition(), new Vector3f(murs.get(i).getScaleX(),entities.get(i).getScaleY(),murs.get(i).getScaleZ()),player_))
		    	player_.setSpeed(0);
		    player_.move(terrains.get(1),roues_,roues2_);
			}
			if(terrains.get(2).getTerrain3())
			{
			roues_.get(0).setParent(player_,terrains.get(2),9,14);
			roues_.get(1).setParent(player_,terrains.get(0),-6.5f,-1.5f);
			roues2_.get(0).setParent(player_,terrains.get(0),9,14);
			roues2_.get(1).setParent(player_,terrains.get(0),-6.5f,-1.5f);
			for(int i=0;i<murs.size();i++)
			if(collid.isCollideDroite(player_.getPosition(),new Vector3f(player_.getScaleX(),player_.getScaleY(),player_.getScaleZ()),murs.get(i).getPosition(), new Vector3f(murs.get(i).getScaleX(),entities.get(0).getScaleY(),murs.get(i).getScaleZ()),player_))
				player_.setSpeed(0);
			...
			{
			roues_.get(0).setParent(player_,terrains.get(0),9,14);
			roues_.get(1).setParent(player_,terrains.get(3),-6.5f,-1.5f);
			roues2_.get(0).setParent(player_,terrains.get(0),9,14);
			roues2_.get(1).setParent(player_,terrains.get(0),-6.5f,-1.5f);
			for(int i=0;i<murs.size();i++)
			if(collid.isCollideDroite(player_.getPosition(),new Vector3f(player_.getScaleX(),player_.getScaleY(),player_.getScaleZ()),murs.get(i).getPosition(), new Vector3f(murs.get(i).getScaleX(),murs.get(i).getScaleY(),murs.get(i).getScaleZ()),player_))
			...
			master.renderScene(roues_,roues2_,p,entities,murs, terrains, light_, cam,new Vector4f(0,1,0,-waters.get(0).getHeight()+1));
			
			cam.getPosition().y+=distance;
			cam.invertPitch();
		
			fbo.bindReflectionFrameBuffer();
		    master.renderScene(roues_,roues2_,p,entities,murs, terrains, light_, cam,new Vector4f(0,1,0,-water.getHeight()));
		
			fbo.bindRefractionFrameBuffer();
			master.renderScene(roues_,roues2_,p,entities, murs,terrains, light_, cam,new Vector4f(0,-1,0,waters.get(0).getHeight()+0.2f));
			
			GL11.glDisable(GL30.GL_CLIP_DISTANCE0);

			
			fbo2.bindFrameBuffer();
			master.renderScene(roues_,roues2_,p,entities,murs, terrains, light_, cam,new Vector4f(0,-1,0,10000));
